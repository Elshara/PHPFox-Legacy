...
class Feed_Component_Block_Display extends Phpfox_Component 
{
	...
	public function process()
	{
		...
		{
			$aRows = Phpfox::getService('feed')->callback($aFeedCallback)->get(($bIsProfile > 0 ? $iUserId : null), ($this->request()->get('feed') ? $this->request()->get('feed') : null), $iFeedPage, false, $iLastFeedId);
