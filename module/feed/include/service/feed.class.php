...
{	
	...
	public function get($iUserid = null, $iFeedId = null, $iPage = 0, $bForceReturn = false, $iLastFeedId = null)
	{
		...
		else
		{
			...
			if (Phpfox::isModule('privacy') && Phpfox::getUserParam('privacy.can_view_all_items'))
			{
				...
				$aCond = array();
				$aCond[] = 'AND feed.time_stamp > \'' . $iLastActiveTimeStamp . '\'';
				$aCond[] = 'AND feed.feed_reference = 0';
				if ($sLoadMoreCond != null) {
					$aCond[] = $sLoadMoreCond;
				}
